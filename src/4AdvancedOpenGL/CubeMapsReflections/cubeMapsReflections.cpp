...
int main() {
    ...
    // compile shaders
    Shader lightingShader("src/4AdvancedOpenGL/CubeMapsReflections/colors.vert", "src/4AdvancedOpenGL/CubeMapsReflections/colors.frag");
    Shader cubeMapShader("src/4AdvancedOpenGL/CubeMapsReflections/cubeMap.vert", "src/4AdvancedOpenGL/CubeMapsReflections/cubeMap.frag");
    ...
    while (Running)
    {
        ...
        lightingShader.setVec3("cameraPos", camera.Position.x, camera.Position.y, camera.Position.z);
        // cubes
        glBindVertexArray(cubeVAO);
