...
int main() {
    ...
    // compile shaders
    Shader lightingShader("src/4AdvancedOpenGL/StencilTesting/colors.vert", "src/4AdvancedOpenGL/StencilTesting/colors.frag");
    Shader singleColorShader("src/4AdvancedOpenGL/StencilTesting/colors.vert", "src/4AdvancedOpenGL/StencilTesting/single_color.frag");
    ...
    while (Running)
    {
        ...
        singleColorShader.setMat4("model", glm::value_ptr(model));
        glDrawArrays(GL_TRIANGLES, 0, 36);
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
        model = glm::scale(model, scaleUp);
