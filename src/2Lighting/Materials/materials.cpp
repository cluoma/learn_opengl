...
int main() {
    ...
    // compile shaders
    Shader lightingShader("src/2Lighting/Materials/colors.vert", "src/2Lighting/Materials/colors.frag");
    Shader lightCubeShader("src/2Lighting/Materials/light_cube.vert", "src/2Lighting/Materials/light_cube.frag");
