...
int main() {
    ...
    // compile shaders
    Shader lightingShader("src/2Lighting/LightCasters/colors.vert", "src/2Lighting/LightCasters/colors.frag");
    Shader lightCubeShader("src/2Lighting/LightCasters/light_cube.vert", "src/2Lighting/LightCasters/light_cube.frag");
