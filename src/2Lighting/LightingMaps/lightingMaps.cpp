...
int main() {
    ...
    // compile shaders
    Shader lightingShader("src/2Lighting/LightingMaps/colors.vert", "src/2Lighting/LightingMaps/colors.frag");
    Shader lightCubeShader("src/2Lighting/LightingMaps/light_cube.vert", "src/2Lighting/LightingMaps/light_cube.frag");
