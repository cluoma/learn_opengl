...
int main() {
    ...
    // compile shaders
    Shader lightingShader("src/2Lighting/BasicLighting/colors.vert", "src/2Lighting/BasicLighting/colors.frag");
    Shader lightCubeShader("src/2Lighting/BasicLighting/light_cube.vert", "src/2Lighting/BasicLighting/light_cube.frag");
    ...
    while (Running)
    {
        ...
        lightingShader.use();
        lightingShader.setVec3("objectColor", 1.0f, 0.5f, 0.31f);
        lightingShader.setVec3("lightColor",  1.0f, 1.0f, 0.5f);
