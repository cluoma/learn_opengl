...
int main() {
    ...
    // compile shaders
    Shader lightingShader("src/2Lighting/Spolight/colors.vert", "src/2Lighting/Spolight/colors.frag");
    Shader lightCubeShader("src/2Lighting/Spolight/light_cube.vert", "src/2Lighting/Spolight/light_cube.frag");
